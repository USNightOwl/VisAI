...
const SampleTwoInput = ({ input1, input2, result }: Props) => {
  return (
    <>
      <div className="flex flex-col items-center">
        <div className="w-[100px] h-[100px] flex items-center justify-center overflow-hidden rounded-md ">
          <img src={input1} alt="Input 1" className="max-w-full max-h-full object-contain" />
        </div>
      ...
      <div className="flex flex-col items-center">
        <div className="w-[100px] h-[100px] flex items-center justify-center overflow-hidden rounded-md ">
          <img src={input2} alt="Input 2" className="max-w-full max-h-full object-contain" />
        </div>
        <div className="text-sm mt-2 text-center font-medium">
